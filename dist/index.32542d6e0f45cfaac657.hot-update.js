...
class Route {
  ...
  addRouters() {
    ...
    this.router.get('/', async (ctx, next) => {
      ...
      ctx.response.body = console.log(' ctx.response.body=', shtml.replace('{{root}}', (0,react_dom_server__WEBPACK_IMPORTED_MODULE_14__.renderToString)( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_12___default().createElement(_view_App__WEBPACK_IMPORTED_MODULE_13__.default, null)))); // 替换掉 {{root}} 为我们生成后的HTML
...
;
//# sourceMappingURL=index.32542d6e0f45cfaac657.hot-update.js.map