...
class Route {
  ...
  addRouters() {
    ...
    this.router.get('/', async (ctx, next) => {
      ...
      console.log('renderToString=', (0,react_dom_server__WEBPACK_IMPORTED_MODULE_13__.renderToString)( /*#__PURE__*/React.createElement(_view_App__WEBPACK_IMPORTED_MODULE_12__.default, null)));
      console.log(' ctx.response.body=', shtml.replace('{{root}}', (0,react_dom_server__WEBPACK_IMPORTED_MODULE_13__.renderToString)( /*#__PURE__*/React.createElement(_view_App__WEBPACK_IMPORTED_MODULE_12__.default, null)))); // 替换掉 {{root}} 为我们生成后的HTML
...
;
//# sourceMappingURL=index.c8bfd48120cb1fb59ac4.hot-update.js.map