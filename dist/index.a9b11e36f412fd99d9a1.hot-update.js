...
class Route {
  ...
  addRouters() {
    ...
    this.router.get('*', async (ctx, next) => {//  ctx.response.type = 'html'; //指定content type
      //   let shtml = '';
      //   console.log('html====')
      //   await new Promise((resolve, reject) => {
      //     fs.readFile(path.join(__dirname, '../view/template/index.html'), 'utfa8', function(err, data) {
      //       if (err) {
      //         reject();
...
class App extends (/* unused pure expression or super */ null && (Component)) {
  componentDidMount() {
...
;
//# sourceMappingURL=index.a9b11e36f412fd99d9a1.hot-update.js.map