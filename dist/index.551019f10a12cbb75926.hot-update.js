  ...
  addRouters() {
    ...
    this.router.get('*', async (ctx, next) => {
      ...
      await new Promise((resolve, reject) => {
        fs__WEBPACK_IMPORTED_MODULE_6___default().readFile(path__WEBPACK_IMPORTED_MODULE_7___default().join(__dirname, '../view/index.html'), 'utfa8', function (err, data) {
          if (err) {
            reject();
...
;
//# sourceMappingURL=index.551019f10a12cbb75926.hot-update.js.map