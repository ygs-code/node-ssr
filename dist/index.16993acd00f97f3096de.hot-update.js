...
class Route {
  ...
  addRouters() {
    ...
    this.router.get('/', async (ctx, next) => {
      ...
      ctx.response.body = shtml.replace('{{root}}', (0,react_dom_server__WEBPACK_IMPORTED_MODULE_14__.renderToString)( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_12___default().createElement(_view_App__WEBPACK_IMPORTED_MODULE_13__.default, {
        data: {
          msg: '你好 react ssr'
        }
      })));
...
;
//# sourceMappingURL=index.16993acd00f97f3096de.hot-update.js.map