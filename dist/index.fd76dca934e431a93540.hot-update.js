...
class Route {
  ...
  addRouters() {
    ...
    this.router.get('/', async (ctx, next) => {
      ...
      ctx.response.body = shtml.replace('{{root}}', (0,react_dom__WEBPACK_IMPORTED_MODULE_15__.hydrate)( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_12___default().createElement(_view_App__WEBPACK_IMPORTED_MODULE_13__.default, {
        data: {
          msg: '你好 react ssr'
        }
      })));
...
;
//# sourceMappingURL=index.fd76dca934e431a93540.hot-update.js.map