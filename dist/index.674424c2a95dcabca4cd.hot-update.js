...
class Route {
  ...
  addRouters() {
    ...
    this.router.get('/', async (ctx, next) => {
      ...
      console.log(' ctx.response.body=', shtml.replace('{{root}}', (0,react_dom_server__WEBPACK_IMPORTED_MODULE_14__.renderToString)( /*#__PURE__*/React.createElement(_view_App__WEBPACK_IMPORTED_MODULE_13__.default, null)))); // 替换掉 {{root}} 为我们生成后的HTML

      ctx.response.body = shtml.replace('{{root}}', (0,react_dom_server__WEBPACK_IMPORTED_MODULE_14__.renderToString)( /*#__PURE__*/React.createElement(_view_App__WEBPACK_IMPORTED_MODULE_13__.default, null)));
    }); // 挂载路由中间件
...
;
//# sourceMappingURL=index.674424c2a95dcabca4cd.hot-update.js.map