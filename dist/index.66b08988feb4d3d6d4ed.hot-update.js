...
class Route {
  ...
  addRouters() {
    ...
    this.router.get('/', async (ctx, next) => {
      ...
      console.log((0,react_dom_server__WEBPACK_IMPORTED_MODULE_14__.renderToStaticMarkup)( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_12___default().createElement(_view_App__WEBPACK_IMPORTED_MODULE_13__.default, {
        data: {
          msg: '你好 react ssr'
        }
      }))); // ajax 请求数据
...
;
//# sourceMappingURL=index.66b08988feb4d3d6d4ed.hot-update.js.map