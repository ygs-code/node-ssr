...
console.log('App===', _view_App__WEBPACK_IMPORTED_MODULE_12__.default);
...
class Route {
  ...
  addRouters() {
    new _user__WEBPACK_IMPORTED_MODULE_9__.default(this.app, this.router);
    (0,_bizMod_index__WEBPACK_IMPORTED_MODULE_11__.router)(this.app, this.router); // new bizMod.abnormity.script.router(this.app, this.router)
    ...
    this.router.get("/data", async (ctx, next) => {
      ...
      const baseSchema = `
              ...
              `;
      const schema = (0,graphql_tools__WEBPACK_IMPORTED_MODULE_8__.makeExecutableSchema)({
        typeDefs: [schema.typeDefs.schema // baseSchema,
        // typeDefs,
        //   baseSchema,
        //   userType,
        //   songType,
        ...
        resolvers: schema.resolvers //  merge(
        //   {},
        //   userResolvers,
        //   songResolvers,
        //   playlistResolvers
      ...
      await (0,graphql__WEBPACK_IMPORTED_MODULE_0__.graphql)(schema, query, {
        ctx,
        next
      }, variables).then(data => {
        const {
...
;
//# sourceMappingURL=index.9158b681ced6eaea4dd4.hot-update.js.map