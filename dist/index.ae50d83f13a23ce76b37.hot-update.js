  ...
  addRouters() {
    ...
    this.router.get('/', async (ctx, next) => {
      ...
      await new Promise((resolve, reject) => {
        console.log(path__WEBPACK_IMPORTED_MODULE_7___default().join(__dirname, '../view/template/index.html'));
      ...
      console.log(' ctx.response.body=', shtml.replace('{{root}}', (0,react_dom_server__WEBPACK_IMPORTED_MODULE_14__.renderToString)( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_12___default().createElement(_view_App__WEBPACK_IMPORTED_MODULE_13__.default, null))));
      console.log(' ctx.response.body=', shtml.replace('{{root}}', (0,react_dom_server__WEBPACK_IMPORTED_MODULE_14__.renderToString)( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_12___default().createElement(_view_App__WEBPACK_IMPORTED_MODULE_13__.default, null)))); // 替换掉 {{root}} 为我们生成后的HTML

      ctx.response.body = shtml.replace('{{root}}', (0,react_dom_server__WEBPACK_IMPORTED_MODULE_14__.renderToString)( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_12___default().createElement(_view_App__WEBPACK_IMPORTED_MODULE_13__.default, null)));
    }); // 挂载路由中间件
...
;
//# sourceMappingURL=index.ae50d83f13a23ce76b37.hot-update.js.map